        ...
        <div className="contact__content">
          ...
          <div className="contact__info">
            <div className="contact-card">
              <i className="bx bx-envelope-open contact__card-icon"></i>
              <h3 className="contact__cart-tile">Email</h3>
              <span className="contact__card-data">
                namanrathore297@gmail.com
              </span>
              <a
                href="mailto:namanrathore297@gmail.com"
            ...
            <div className="contact-card">
              ...
              <h3 className="contact__cart-tile">instaram</h3>
              <span className="contact__card-data">Naman Rathore</span>
              <a
